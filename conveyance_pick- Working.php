            ...
            <div class="container-fluid">
                ...
                <div class="row m-0 p-0 finish-box" id="kanban_area">
                    <div class="col-md-3 align-items-center"
                        ...
                        <div id="date_picker" class="text-center"
                             style="width: 100%; font-size: 24px; font-weight: 600">
                            <input class="form-control" type="text"
                                   id="pick_date" name="pick_date"
                    ...
                    <div class="col-md-6 text-center">
                        <div class="item-div" id="input_div">
                            <input type="text" class="form-control kanban_input"
                                   id="kanban_input" name="kanban_input"
                                   autofocus placeholder="INPUT">
                        </div>
                    </div>
                    <div class="col-md-3 align-items-center"
                         style="display: flex">
                        <button class="btn text-center" id="button_dolly"
                                style="margin: 0 auto; width: 219px; background-color: #3B23A7; color: #FFF;">
                            Dolly
                        </button>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="font-2"
                             style="color: #fff; font-size: 10px; background: #3b3b3b;">
                            Kanban:
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="font-2"
                             style="color: #fff; font-size: 10px; background: #3b3b3b; margin-top: 15px;">
                            Pick
                            Address:
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="font-3" style="font-size: 22px;">
                            <span class=""
                                  style="color: #000;">Pick List:</span>
                  ...
                  <select name="zone_select" id="zone_select">
                    ...
                    <div class="col-md-2"
                         style="background-color: #fff; border-right: 0"></div>
                </div>
                ...
                <div class="row m-0 p-0 finish-box">
                    <div class="col-md-12 align-items-center"
                         style="display: flex; height: 40px; text-align: center">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-success"
                        id="confirm_help_with_user" style="width: 160px;">OK
                </button>
            </div>
        </div>
        <!-- /.modal-content -->
                                ...
                                if (optionValues.includes(value1)) {
                                    ...
                                    $.ajax({
                                        ...
                                        if (result !== 'failure') {
                                            ...
                                            //$("#button_dolly").css('background-color', data.dolly_color);
                                            // read_kanban_box();
                                            // $(".finish-box").addClass("green-kanban").removeClass("blue-kanban").removeClass(
                                            //     "red-kanban");
                                            // playAudio('assets/audio/Kanban_success.wav');
                                            ...
                                            read_kanban_box();
                                            $(".finish-box")
                                                .addClass("green-kanban")
                                                .removeClass("blue-kanban")
                                                .removeClass("red-kanban");
                                            playAudio('assets/audio/Kanban_success.wav');
